...
internal sealed class StationTxProductionLifecycle : IAsyncDisposable
{
    ...
    private readonly IStationTxProductionEmergencyUnkeyTransport
        m_productionEmergencyUnkeyTransport;
            ...
            productionActivationConfiguration = null)
    {
        ...
        m_stationCommandBoundary = new StationTxCommandBoundary(
            ...
            m_timeProvider);
        m_stationCommandSafetyArmAuthority =
            new StationTxSafetyArmAuthority(
                () => m_stationCommandBoundary.Capabilities,
                () => m_stationCommandAdapterComposition.Snapshot,
                () => commandGateExecutor.Capabilities,
                () => m_commandGate.Capabilities,
                () => m_commandGate.Snapshot,
                () => m_supervisor.Snapshot,
                ResolveStationCommandAuthority,
                m_timeProvider);
        m_stationCommandSafetyArmComposition =
    ...
    public StationTxLifecycleDiagnostics Snapshot
    {
        get
        {
            ...
            StationTxProductionEmergencyUnkeyTransportDiagnostics
                emergencyTransport =
                    m_productionEmergencyUnkeyTransport.Snapshot;
